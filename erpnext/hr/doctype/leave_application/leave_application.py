    ...
    def validate_balance_leaves(self):
        if self.from_date and self.to_date:
            ...
            self.total_leave_days = get_number_of_leave_days(self.employee, self.leave_type,
                self.from_date, self.to_date, self.from_date_session, self.to_date_session,date_dif)
...
@frappe.whitelist()
def get_number_of_leave_days(employee, leave_type, from_date, to_date,from_date_session=None,  to_date_session=None, date_dif=None):
    number_of_days = 0
